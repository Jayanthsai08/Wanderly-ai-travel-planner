    ...
    <div>
      <div className='bg-purple-300 h-full'>
        <div className='flex flex-col items-center mx-4 md:mx-12 lg:mx-60 gap-9 px-4 md:px-10 lg:px-14'>
          <h1 className='font-black text-4xl md:text-5xl lg:text-[60px] text-center mt-8 md:mt-16'>
            <span className='text-white'>Your Perfect Trip, Curated by AI:</span>{' '}
            <span className='text-black'>Effortless Itineraries in Seconds.</span>
      ...
      <div className='bg-gradient-to-b from-purple-300 to-white'>
        ...
        <Link to={'/create-trip'}>
          <Button className='mt-6 md:mt-8 lg:mt-11 rounded-lg p-4 md:p-5 lg:p-5 py-3 md:py-4 lg:py-5 '>
            <h2 className='text-lg md:text-xl lg:text-2xl'>Plan a trip.</h2>
          </Button>
        </Link>
        ...
        <div className='flex flex-col md:flex-row items-center px-4 md:px-10 lg:px-30 ml-2, md:ml-20, lg:ml-32'>
          <img
            ...
            alt='Map'
          />
          <div className='mt-2 md:mt-2 lg:mt-4 ml-20 md:ml-14 lg:ml-20 shadow-xl w-full md:w-[600px] lg:w-[600px]  rounded-3xl bg-white'>
      ...
      <div className='bg-[url("/back.jpg")] h-full bg-cover'>
        <div className='flex flex-col md:flex-row items-center px-4 md:px-10 lg:px-30 ml-2, md:ml-20, lg:ml-32'>
          <img
            ...
            alt='AI'
          />
          <div className='mt-2 md:mt-2 lg:mt-0 md:ml-14 lg:ml-20  shadow-xl w-full md:w-[600px] lg:w-[600px] rounded-3xl bg-white'>
            <h2 className='font-bold text-xl md:text-2xl lg:text-[30px] mt-6 md:mt-10 text-left px-6 md:px-8 lg:px-12'>
        ...
        <div className='flex flex-col md:flex-row items-center px-4 md:px-10 lg:px-30 ml-2 md:ml-20, lg:ml-32'>
          <img
            ...
            alt='Passport'
          />
          <div className='mt-2 md:mt-2 lg:mt-4 md:ml-14 lg:ml-20 shadow-xl w-full md:w-[600px] lg:w-[600px] rounded-3xl bg-white'>
            <h2 className='font-bold text-xl md:text-2xl lg:text-[30px] mt-6 md:mt-10 text-left px-6 md:px-8 lg:px-12'>
              Explore Your Trip
            </h2>
            <h2 className='text-gray-400 font-semibold text-base md:text-lg lg:text-[20px] px-6 md:px-8 lg:px-12 py-2 md:py-4 text-left'>
