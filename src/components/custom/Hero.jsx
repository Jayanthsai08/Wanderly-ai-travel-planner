    ...
    <div>
      <div className='bg-gradient-to-b from-black to bg-gray-700 h-full'>
        <div className='flex flex-col items-center mx-4 md:mx-12 lg:mx-60 gap-9 px-4 md:px-10 lg:px-14'>
          <h1 className='font-black text-4xl md:text-5xl lg:text-[60px] text-center mt-22 md:mt-16 lg:mt-28'>
      ...
      <div className='bg-gradient-to-b from-gray-700 to-white'>
        ...
        <Link to={'/create-trip'}>
          ...
          <Button className='mt-6 md:mt-8 lg:mt-11 rounded-full p-4 md:p-5 lg:p-5 py-3 md:py-4 lg:py-5 hover:scale-110 transition-all '>
